...
## Path Migration Notice (May 2026)

This registry was generated from the pre-migration snapshot. Repositories have been moved to a centralized platform-first hierarchy under `repos/`.

- Legacy first-party projects are now under `repos/desktop/linux/` and `repos/mobile/android/`.
- Legacy tooling projects are now under `repos/desktop/linux/security-tools/`, `repos/mobile/android/security-tools/`, and `repos/web/security-tools/`.
- Use `../../docs/REPO-MIGRATION-MAP.md` for exact old-to-new path mapping.
