# Homebrew Tap for Aegis Nexus (macOS)
# Save as: homebrew/aegis-nexus.rb

class AegisNexus < Formula
  desc "Next-Gen Mobile Security Platform with AI, Mesh, eBPF, PQ Crypto"
  homepage "https://aegis-nexus.org"
  url "https://github.com/AegisNexus/aegis-nexus/archive/refs/tags/v3.0.tar.gz"
  sha256 "SKIP"  # Will be auto-filled on first build
  head "https://github.com/AegisNexus/aegis-nexus.git", branch: "main"
  ...
  def post_install
    ohai "✅ Aegis Nexus installed!"
    ohai "   Run: nhctl help"
    ohai "   Docs: https://aegis-nexus.org/docs"
  end
  ...
  def caveats
    <<~EOS
Aegis Nexus v3.0 — Next-Gen Mobile Security Platform
