...
```
armored-core/
├── matrix/bin/           # Unified entry point (nmatrix)
├── matrix/lib/           # Cross-platform abstraction
├── matrix/plugins/       # 158 tool plugins
│   ├── shell/          # 150 nh-* shell tools
│   └── python/         # AI agent + Python tools
├── matrix/api/           # FastAPI Web API (9+ endpoints)
├── matrix/web/           # Web dashboard (Three.js/WebXR)
